...
def test_paged_attention(
    ...
    mask = pysmctrl.generate_mask(allocated_tpc)
    pysmctrl.set_stream_mask(torch_stream, mask)
    # synchronize
    ...
    if version == "v1":
        with torch.cuda.stream(torch_stream):
            ...
            print(f"{(end - start)*1e3} {num_seqs} {allocated_tpc}")
