...
DTYPES = [torch.float] 
NUM_GEN_SEQS = [10,20,40,80,100]  # Arbitrary values for testing
...
@pytest.mark.parametrize("allocated_tpc", ALLOCATED_TPC)
def test_paged_attention(
    ...
    key_caches, value_caches = kv_cache_factory(NUM_BLOCKS, block_size, 1,
                                                ...
                                                device)
    # print(f"key_caches shape: {key_caches.shape}")
    ...
    if version == "v1":
        ...
        print(f"{(end_time - start_time)*1e6} {num_seqs} {allocated_tpc}")
    elif version == "v2":
